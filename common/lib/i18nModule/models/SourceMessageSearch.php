...
/**
 * SourceMessageSearch represents the model behind the search form about `common\lib\i18nModule\models\SourceMessage`.
 */
class SourceMessageSearch extends SourceMessage
{
    ...
    public function getColumns()
    {
        ...
        $columns[] = [
            'attribute' => 'category',
            'filter' => \yii\helpers\ArrayHelper::map(TranslateCategory::find()->all(), 'name', 'name'),
