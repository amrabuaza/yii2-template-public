...
namespace backend\modules\privateApi\models\authorization;
...
class LoginForm extends Model
{
    ...
    /**
     * Finds user by [[phone number or email]]
     *
     * @return User|null
     */
    protected function getUser()
    {
        ...
        if (isset($this->phone_number)) {
            $this->loginType = self::TYPE_PHONE_NUMBER;
        } else {
            $this->loginType = self::TYPE_EMAIL;
        }
    ...
    public function login()
    {
        if ($this->validate()) {
            ...
            if ($isLogin) {
                $this->accessToken = $this->getUser()->generateAccessToken();
            }
            return $isLogin;
        }
        return false;
